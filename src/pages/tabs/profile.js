...
const Profile = () => {
    return (
      ...
      <Text align="left">
        Hey! My name is Dennis and I'm a student who pivoted to studying Computer Science
        after finishing an Honours in Biology. Right now, I'm absorbed with computer hardware, mobile app development, and front-end design.
      </Text>
      <br />
      <Text>
        I dove into the accelerated second bachelors degree
        for Computer Science (BCS) at the University of British Columbia
        after being fascinated by the tailored hardware and software setup that
         played a critical in my thesis
        research on fruit fly memory formation. During my studies, I hope to
        use the skills I gained during my Biology degree to
        deepen my understanding of how programs communicate with hardware
        and to catch up to the breakneck pace of today's technological integration.
      </Text>
      <br />
